...
public class PlayerShoot : NetworkBehaviour
{
    ...
    void Start()
    {
        if (cam == null)
        {
            Debug.LogError("Pas de camera dans le système de tir.");
            this.enabled = false;
        }
    ...
    //Fct appelée sur le serv quand notre joueur tir (On prévient le serv du tir)
    [Command]
    void CmdOnShoot()
    {
        RpcDoShootEffect();
    ...
    //Fait appartaitre les tirs chez tt le monde
    [ClientRpc]
